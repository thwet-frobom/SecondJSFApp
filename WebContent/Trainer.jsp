...
<f:view>
        ...
        <h:form>
                <h:panelGrid columns="3">
                        ...
                        <h:inputText id="left" value="#{cardData.left}"></h:inputText>
                        <h:message for="left"></h:message>

                        <h:outputLabel value="#{msg.right}"></h:outputLabel>
                        <h:inputText id="right" value="#{cardData.right}">
                        </h:inputText>
                        <h:message for="right"></h:message>

                </h:panelGrid>
                <h:commandButton action="#{cardData.show}" value="#{msg.show}"></h:commandButton>
                <h:commandButton action="#{cardData.clear}" value="#{msg.reset}"
                        immediate="true"></h:commandButton>
                <h:messages layout="table"></h:messages>
        </h:form>

        <h:panelGrid rendered="#{cardData.result!=0}" columns="3">
                <h:outputLabel value="#{msg.result}"></h:outputLabel>
                <h:inputText id="result" value="#{cardData.result}">
                </h:inputText>
